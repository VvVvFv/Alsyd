...
if hash or SudoBot(msg) or DevAlsydW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAlsydW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAlsydW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAlsydW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAlsydW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAlsydW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local Alsyd_Msg = ''  
if msgs < 100 then 
Alsyd_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Alsyd_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Alsyd_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Alsyd_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Alsyd_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Alsyd_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Alsyd_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Alsyd_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Alsyd_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Alsyd_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Alsyd_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Alsyd_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Alsyd_Msg = 'رب التفاعل'  
end 
return Alsyd_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@vvvvFv")  
...
--------------------------------------------------------------------------------------------------------------
function SourceAlsyd(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Alsyd1:List:Filter"..sl)
...
if not DevAlsydW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevAlsydW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Alsyd_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevAlsydW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevAlsydW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevAlsydW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevAlsydW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevAlsydW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevAlsydW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevAlsydW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevAlsydW(msg) then 
os.execute('rm -rf Alsyd.lua')
os.execute('wget https://raw.githubusercontent.com/VvVvFv/Alsyd/main/Alsyd.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس تيلاند*\n*⌯︙الاصدار » { 2.8v}*')
dofile('Alsyd.lua')  
end
if text == 'الاصدار ⌯' and DevAlsydW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس تيلاند* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevAlsydW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/AlsydTEAM) \n⌯︙[قناه السورس](t.me/IIIS1)')
end
if text == "ضع اسم للبوت ⌯" and DevAlsydW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevAlsydW(msg) then 
...
if text == 'المشتركين ⌯' and DevAlsydW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevAlsydW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevAlsydW(msg) then
...
if text == ("قائمه العام ⌯") and DevAlsydW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevAlsydW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevAlsydW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevAlsydW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevAlsydW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevAlsydW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevAlsydW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevAlsydW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevAlsydW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevAlsydW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..Alsydk..''..Alsyd..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevAlsydW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevAlsydW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAlsydW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevAlsydW(msg) then
...
local Alsyd1_Msg = database:get(bot_id.."Alsyd1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Alsyd1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Alsyd_Msg and not Special(msg) then  
local Alsyd_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Alsyd_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevAlsydW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevAlsydW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevAlsydW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevAlsydW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevAlsydW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevAlsydW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevAlsydW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevAlsydW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevAlsydW(msg) then  
...
database:sadd(bot_id.."Alsyd:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Alsyd:blocname"..msg.chat_id_)
...
function vvvvFv_name(t1,t2)
if t2.id_ then 
name_Alsyd = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Alsyd then 
names_Alsyd = database:smembers(bot_id.."Alsyd:blocname"..msg.chat_id_) or ""
if names_Alsyd and names_Alsyd[1] then 
for i=1,#names_Alsyd do 
if name_Alsyd:match("(.*)("..names_Alsyd[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, vvvvFv_name)
end
...
database:set(bot_id.."Alsyd:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Alsyd:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Alsyd:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Alsyd:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Alsyd:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Alsyda_new(Alsyd1,Alsyd2)
if Alsyd2 and Alsyd2.first_name_ then 
if Alsyd2.first_name_:match("(.*)"..database:get(bot_id.."Alsyd:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Alsyd:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Alsyd_nnn = database:get(bot_id.."Alsyd:nump"..msg.chat_id_) or 5
local Alsyd_nnn2 = database:get(bot_id.."Alsyd:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Alsyd_nnn2) == tonumber(Alsyd_nnn) or tonumber(Alsyd_nnn2) > tonumber(Alsyd_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Alsyd:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..Alsyd2.username_.."](https://t.me/"..(Alsyd2.username_ or "IIIS1")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Alsyd:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(Alsyd_nnn) - tonumber(Alsyd_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Alsyda_new)
end
end
...
local AlsydChengName = database:get(bot_id.."Alsyd:Cheng:Name"..data.id_)
if not data.first_name_ then 
if AlsydChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..AlsydChengName..']')
database:del(bot_id.."Alsyd:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if AlsydChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Alsyd:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local AlsydChengUserName = database:get(bot_id.."Alsyd:Cheng:UserName"..data.id_)
if not data.username_ then 
if AlsydChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..AlsydChengUserName..']')
database:del(bot_id.."Alsyd:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if AlsydChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Alsyd:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local AlsydChengPhoto = database:get(bot_id.."Alsyd:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if AlsydChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Alsyd:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if AlsydChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Alsyd:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @SR_JO .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ  ᴀʟsʏᴅ\n\n[⌯   ᴀʟsʏᴅ ᴄʜᴀɴɴᴇʟ](https://t.me/Source_Alsyd)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/SR_JO)\n\n[⌯   ᴀʟsʏᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/vvvvFv)\n\n[⌯  ʙᴏᴛ  ᴀʟsʏᴅ](http://t.me/XwuBoT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ  ᴀʟsʏᴅ',url="t.me/Source_Alsyd/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AlsydTEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevAlsydW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevAlsydW(msg) then
dofile('Alsyd.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevAlsydW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevAlsydW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if AlsydSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevAlsydW(msg) then
...
if AlsydSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevAlsydW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevAlsydW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevAlsydW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevAlsydW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevAlsydW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevAlsydW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevAlsydW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevAlsydW(msg) then
...
if database:get(bot_id.."vvvvFv:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'vvvvFv:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevAlsydW(msg) then
...
if DevAlsydW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/VvVvFv/Files_Alsyd/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevAlsydW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/VvVvFv/Files_Alsyd/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevAlsydW(msg) then
...
if text == "مسح الملفات" and DevAlsydW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevAlsydW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevAlsydW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_Alsyd(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alsyd, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Alsyd, nil)
return false 
end
...
database:set(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Alsyd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Alsyd1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Alsyd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Alsyd1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Alsyd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Alsyd1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Alsyd1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Alsyd1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Alsyd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Alsyd1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Alsyd1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevAlsydW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevAlsydW(msg) then
...
if text == 'تفعيل الاذاعه' and DevAlsydW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevAlsydW(msg) then  
...
if not database:get(bot_id..'vvvvFv:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'vvvvFv:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..Alsyd_Msg[math.random(#Alsyd_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevAlsydW(msg) then 
...
if AlsydSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevAlsydW(msg) then 
...
if text == ("ردود المطور") and DevAlsydW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevAlsydW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevAlsydW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevAlsydW(msg) then   
...
if text == 'تعطيل المغادره' and DevAlsydW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'AlsydTEAM')..') '
...
-- vardump(data) 
Alsyddx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevAlsydW(msg) then
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/AlsydTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
inline = {
{{text = 'sᴏᴜʀᴄʀ  ᴀʟsʏᴅ',url='https://t.me/Source_Alsyd'}},
}
...
Alsyd = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Alsyd)
...
--------------------------------------------------------------------------------------------------------------
SourceAlsyd(data.message_,data)
...
------------------------------------------------------------------------
local AlsydAbot = database:get(bot_id.."Alsyd1:Add:Filter:Rp2"..text..result.chat_id_)   
if AlsydAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..AlsydAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Alsyd1_Msg = database:get(bot_id.."Alsyd1:Add:Filter:Rp2"..text..result.chat_id_)   
if Alsyd1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..Alsyd1_Msg)
